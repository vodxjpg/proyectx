...
import { cx, focusRing } from "@/components/lib/utils"
  ...
  return (
    <CheckboxPrimitives.Root
      ...
      className={cx(
        ...
        // checked and enabled
        "enabled:data-[state=checked]:border-0 enabled:data-[state=checked]:border-transparent enabled:data-[state=checked]:bg-black",
        // indeterminate
        "enabled:data-[state=indeterminate]:border-0 enabled:data-[state=indeterminate]:border-transparent enabled:data-[state=indeterminate]:bg-black",
        // focus
        focusRing,
        className,
      )}
